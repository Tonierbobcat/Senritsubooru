<div class='readonly-sidebar'>
    <article class='details'>
        ...
        <section class='search'>
            ...
            <a href='http://waifu2x.booru.pics/Home/fromlink?denoise=1&scale=2&url=<%- encodeURIComponent(ctx.post.fullContentUrl) %>'>Waifu2x</a><br>
            <a href='http://saucenao.com/search.php?db=999&url=<%- encodeURIComponent(ctx.post.fullContentUrl) %>'>SauceNAO</a><br>
            <a href='https://lens.google.com/uploadbyurl?url=<%- encodeURIComponent(ctx.post.fullContentUrl) %>&client=app'>Google Lens</a><br>
